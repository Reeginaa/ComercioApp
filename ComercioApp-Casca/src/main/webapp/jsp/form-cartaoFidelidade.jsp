...
<div class="container">
    <form action="/cartaoFidelidade" method="post"  role="form" data-toggle="validator" >
        ...
        <div class="form-group-lg col-xs-4">
        ...
        <div class="form-group-lg col-xs-4">
            <label for="fatorConversao" class="control-label col-xs-6">Fator Conversão:</label>
        ...
        <br><br><br>
            <button type="submit" class="btn btn-primary  btn-default">Gravar</button> 
        </div>                                                      
    </form>
</div>
